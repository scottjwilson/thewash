      ...
      <div className="h-screen lg:grid grid-cols-2 items-center px-6 container mx-auto">
        <div className="flex flex-col py-2 lg:py-8 md:mx-2">
          ...
          <div className="flex lg:py-6">
            <button
              type="button"
              className="md:py-4 py-2 px-4 md:px-8 my-6 bg-white rounded-md shadow flex items-center"
            >
              Learn More
              <svg
                className="h-4 ml-2"
            ...
            <button
              type="button"
              className="md:py-4 py-2 px-4 md:px-8 my-6 md:mx-6 mx-4 bg-white rounded-md shadow flex items-center "
            >
              Contact Us{" "}
              <svg
                className="h-4 ml-2"
